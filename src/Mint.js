...
// const CONFETTI_LIGHT = 'url("/appa-small.svg")'
...
export default function ContactFormWithSocialButtons() {
    ...
    const [hasProof, setProof] = useState({});
    const {
        handleSubmit,
        register,
    ...
    async function onSubmit(values) {
        ...
        console.log('uploadField', fileUploadResult);
        // if (fileError) {
    ...
    return (
        <div>
            <Flex
                ...
                id="contact">
                <Skeleton isLoaded={!done}>
                    <Box
                        borderRadius="lg"
                        m={{ base: 5, md: 12, lg: 10 }}
                        p={{ base: 5, lg: 16 }}>
                        <Box>
                            <VStack spacing={{ base: 4, md: 12, lg: 20 }}>
                                <Heading
                                    fontSize={{
                                        base: '4xl',
                                        md: '5xl',
                                ...
                                {!isRealHuman && <WorldIDWidget
                                    actionId="wid_staging_c93f74d81132cf2b94e54f2851159583" // obtain this from developer.worldcoin.org
                                    signal="minting"
                                    enableTelemetry
                                ...
                                {!isRealHuman && <Button onClick={() => setIsRealHuman(true)} >Skip</Button>}
                                {isRealHuman &&
                                    <Stack
